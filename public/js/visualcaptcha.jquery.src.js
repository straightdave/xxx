...
define('visualcaptcha/config',[ 'visualcaptcha/xhr-request' ], function( xhrRequest ) {
    ...
    return function( options ) {
        ...
        // dave modified root path of captcha routes
        var rootPath = window.location.protocol + '//' + window.location.host;
        var config = {
            /* REQUEST */
            request: xhrRequest,
            url: rootPath + '/captcha',
            namespace: '',
...
define( 'visualcaptcha/language',[],function() {
    ...
    return {
        ...
        explanation: '点击下面的 <strong>ANSWER</strong>',
        refreshAlt: '刷新图标',
        refreshTitle: '刷新/重新载入新的图标！'
    };
} );
/*global define */
